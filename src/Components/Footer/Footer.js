...
function Footer() {
    ...
    return (
        <div className='mt-12 flex items-center flex-col'>
            ...
            <div className='flex mt-10 gap-4 animate-[fadeIn_6s_ease-in-out] justify-center lg:flex-row flex-col'>
            ...
            <div className='mt-10 text-white text-center md:text-2xl'>
                <h3>© 2023 MAESTRO</h3>
